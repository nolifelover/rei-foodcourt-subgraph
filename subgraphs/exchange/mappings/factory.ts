...
export function handlePairCreated(event: PairCreated): void {
  log.info("pair created {} {}", [event.params.token0.toHex(), event.params.token1.toHex()])
  ...
  log.info("token0 {} loaded", [event.params.token0.toHex()])
  if (token0 === null) {
  ...
  log.info("token1 {} loaded", [event.params.token0.toHex()])
  if (token1 === null) {
